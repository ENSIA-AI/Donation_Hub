maram lahmar, [2/6/2026 11:41 PM]
<?php
...
// // Autocomplete
Route::get('/organizatio

maram lahmar, [2/6/2026 11:41 PM]
n/autocomplete', [OrganizationController::class, 'autocomplete']);
Route::get('/organization/search', [OrganizationController::class, 'search']); // this is for searching org based on naem , wilaya and category
